    ...
    CommandLineRunner seedDatabase(
        ...
        return args -> {
            ...
            if (!specializationCount && !doctorCount && !patientCount && !appointmentCount) {
                ...
                List<Specialization> listOfSpecializations = List.of(cardiology, pediatrics, dermatology, orthopedics,
                        neurology);
                ...
                List<Doctor> listOfDoctors = List.of(doctor1, doctor2, doctor3, doctor4, doctor5, doctor6, doctor7,
                        doctor8,
                        doctor9, doctor10, doctor11, doctor12, doctor13, doctor14, doctor15, doctor16, doctor17,
                        doctor18);
                ...
                Patient patient3 = new Patient("River", "Brook", "river.brook@example.com", LocalDate.of(1992, 9, 12));
                Patient patient4 = new Patient("Sunny", "Field", "sunny.field@example.com", LocalDate.of(1988, 7, 1));
                Patient patient5 = new Patient("Aspen", "Grove", "aspen.grove@example.com", LocalDate.of(1995, 11, 25));
                Patient patient6 = new Patient("Ivy", "Moss", "ivy.moss@example.com", LocalDate.of(2000, 2, 14));
                Patient patient7 = new Patient("Reed", "Stone", "reed.stone@example.com", LocalDate.of(1983, 8, 10));
                Patient patient8 = new Patient("Sky", "Meadow", "sky.meadow@example.com", LocalDate.of(1998, 4, 5));
                Patient patient9 = new Patient("Maple", "Hill", "maple.hill@example.com", LocalDate.of(1993, 12, 30));
                Patient patient10 = new Patient("Cliff", "Leaf", "cliff.leaf@example.com", LocalDate.of(1980, 5, 17));
                Patient patient11 = new Patient("Fern", "Vale", "fern.vale@example.com", LocalDate.of(1991, 1, 3));
                Patient patient12 = new Patient("Blossom", "Petal", "blossom.petal@example.com",
                        LocalDate.of(1987, 10, 21));
                Patient patient13 = new Patient("Cedar", "Trail", "cedar.trail@example.com", LocalDate.of(1979, 7, 9));
                Patient patient14 = new Patient("Lake", "Shore", "lake.shore@example.com", LocalDate.of(1994, 5, 26));
                Patient patient15 = new Patient("Daisy", "Bloom", "daisy.bloom@example.com", LocalDate.of(1999, 4, 11));
                Patient patient16 = new Patient("Pine", "Forest", "pine.forest@example.com", LocalDate.of(1986, 6, 30));
                Patient patient17 = new Patient("Violet", "Garden", "violet.garden@example.com",
                        LocalDate.of(1997, 8, 15));
                Patient patient18 = new Patient("Ash", "Glen", "ash.glen@example.com", LocalDate.of(1992, 12, 3));
                Patient patient19 = new Patient("Rose", "Thorn", "rose.thorn@example.com", LocalDate.of(1984, 2, 29));
                ...
                Patient patient23 = new Patient("Briar", "Patch", "briar.patch@example.com", LocalDate.of(1996, 4, 14));
                Patient patient24 = new Patient("Sage", "Cliff", "sage.cliff@example.com", LocalDate.of(1990, 7, 19));
                Patient patient25 = new Patient("Laurel", "Branch", "laurel.branch@example.com",
                        LocalDate.of(1993, 5, 6));

                List<Patient> listOfPatients = List.of(patient1, patient2, patient3, patient4, patient5, patient6,
                        patient7, patient8, patient9, patient10, patient11, patient12, patient13, patient14, patient15,
                        patient16, patient17, patient18, patient19, patient20, patient21, patient22, patient23,
                        patient24, patient25);
                ...
                // ! Print Patients
                System.out
                        .println("Patients look like: " + List.of(patient1, patient2, patient3));

                // Create List of Appointments
                List<Appointment> appointments = AppointmentSeeder.generateAppointments(listOfPatients, listOfDoctors);
